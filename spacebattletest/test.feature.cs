...
#line hidden
        ...
        public ПеремещениеШатлаFeature(ПеремещениеШатлаFeature.FixtureData fixtureData, XUnit_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "", "Перемещение шатла", null, ProgrammingLanguage.CSharp, featureTags);
